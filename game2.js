...
let words={
    movies:["prestige","inception","parasite","interstellar","whiplash","memento","coco","harry-potter"],
    people:["albert-einstine","hitchcock","alexander","cleopatra","mahatma-ghandi"],
    countries:["yamen","egypt","bahrain","algeria","tunis","marroc","qatar"],
    animals:["cat","dog","fox","sheep","panda","lion","snake","cow",],
    programming:["php","javascript","css","html","python","mysql","java","react","vue"],
}
...
let allType=Object.keys(words),
    ...
    console.log(choseOneWord);
    console.log(allLettersOfWords);
            ...
            */ 
            ...
            allLettersOfWords.forEach((letter,letterIndex)=>{
                if(clickedLetter==letter){
                    ...
                    if(letterIndex==lettIndex){
                        ...
                        sucsess=sucsess*1+1;
                        circle.children[0].children[0].textContent=circle.children[0].children[0].textContent*1+100
            ...
            if(shihWalaGhalat==false){
                ...
                if(circle.children[0].children[0].textContent==0){
                    ...
                    circle.children[0].children[0].textContent=circle.children[0].children[0].textContent*1-50
                    score.textContent=circle.children[0].children[0].textContent;
                    score2.textContent=circle.children[0].children[0].textContent;
                }
                if(sucsess2==1){
                ...
                replay.onclick=function(){
                    ...
                    if(sucsess2==0){
                        ...
                        setTimeout(() => {
                            ...
                            hangmanDraw.children[0].children[4].children[0].classList.remove("div4");
                            blood.classList.remove("div5","div6");
                            niveau.classList.remove("niveau1","niveau2","niveau3","niveau4","niveau5","niveau6");
